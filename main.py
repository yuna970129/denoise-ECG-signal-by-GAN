...
def parse_args():
    ...
    parser.add_argument('--gan_type', type=str, default='GAN',
                        choices=['GAN', 'CGAN', 'infoGAN', 'ACGAN', 'EBGAN', 'BEGAN', 'WGAN', 'WGAN_GP', 'DRAGAN', 'LSGAN', 'CLSGAN', 'DCLSGAN'],
    ...
    parser.add_argument('--input_size', type=int, default=500, help='The size of input image')
...
def main():
    ...
    if args.gan_type == 'GAN':
        ...
        gan = LSGAN(args)
    elif args.gan_type == 'CLSGAN':
        gan = CLSGAN(args)
    elif args.gan_type == 'DCLSGAN':
        gan = DCLSGAN(args)
    else:
